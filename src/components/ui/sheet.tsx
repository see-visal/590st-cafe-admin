...
function SheetOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/30 backdrop-blur-xs transition-opacity duration-300",
        className
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col shadow-2xl transition ease-out duration-300",
