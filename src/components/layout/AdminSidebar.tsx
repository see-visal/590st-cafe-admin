...
import { navigationSections } from "@/constants/sidebar.constant";
...
export function Sidebar() {
  ...
  const logo = (
    <Link
      ...
      className="flex h-12 items-center gap-3 px-2 hover:opacity-90"
    >
      <Image
        src="/logos/logo.svg"
        alt="590st CAFE Logo"
        ...
        priority
      />
      <span className="text-[1.1rem] font-medium tracking-wide text-white">
        590st CAFE
      </span>
    </Link>
  );
